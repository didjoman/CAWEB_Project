...
<t:layout title="Permanences">        
    <jsp:body>
        ...
        <h2>Statistiques</h2>
        <h3>Fréquences de permancences des utilisateurs actifs</h3>
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th>Consommateur</th>
                    <th>Frequence des permanences sur la duree d'activité</th>
                </tr>
            </thead>
            <tbody>
                <c:forEach items="${stats2}" var="stat">
                    <tr>
                        <td>${stat.getKey()}</td>
                        <td>${stat.getValue() * 100}%</td>
                    </tr>
                </c:forEach> 
            </tbody>
        </table>
        
        <h3>Nombre de permanences tenues par utilisateur</h3>     
                
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th>Consommateur</th>
                    <th>Nb Permanences</th>
                </tr>
            </thead>
            <tbody>
